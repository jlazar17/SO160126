...
for i in xrange(len(starts)):
    ...
    titles = ['Overlay of IRIG-B, Livingston EX']
    iterative_fetch_save_and_plot(starts[i], ends[i], connl(), channels, stride, irigb_stride_div, titles)

    # run for DuoTone, Hanford EX
    channels = [ch.hanford_duotone_ex]
    titles = ['Overlay of DuoTone, Hanford EX']
    iterative_fetch_save_and_plot(starts[i], ends[i], connh(), channels, stride, duotone_stride_div, titles)
